                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body"> 
                            ...
                            <form action="/shelf/{{$shelf->id}}/update" method="POST" class="row g-3">
                                @csrf
                                <div class="col-md-12">
                                    <label for="" class="form-label">Nama Rak</label>
                                    <input type="text" value="{{$shelf->shelf_name}}" name="shelf_name" class="form-control" aria-describedby="helpId">
                                    @error('shelf_name')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" value="{{$shelf->description}}" name="description" class="form-control" aria-describedby="helpId">
                                    @error('description')
                                        <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
